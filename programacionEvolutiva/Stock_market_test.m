...
options = gaoptimset(options, 'PopulationSize' , 100);                                        % Polulation Size
...
options = gaoptimset(options, 'CrossoverFraction', 0.8);                                        % Crossover rate
options = gaoptimset(options, 'MutationFcn', {@mutationgaussian, 0.05});                        % Mutation Function & Probability
